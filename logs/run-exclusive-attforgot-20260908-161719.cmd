...
echo owner=exclusive-attforgot pid-pending > logs\MIGRATION_LOCK_exclusive-attforgot.txt
...
echo log=logs\migration-exclusive-20260908-161719.log>> logs\MIGRATION_LOCK_exclusive-attforgot.txt
echo STARTED %DATE% %TIME% > logs\exclusive-attforgot-meta.txt
"C:\Program Files\Java\jdk-21\bin\java.exe" -Xmx2g -Dlogging.file.name=logs\migration-app-exclusive-20260908-161719.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=logs/heapdump-exclusive.hprof -jar build\libs\Camel-Jpa-TN-0.0.1-SNAPSHOT.jar --spring.profiles.active=dev > "logs\migration-exclusive-20260908-161719.log" 2>&1
