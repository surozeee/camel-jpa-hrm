...
echo log=logs\migration-exclusive-20260908-160435.log>> logs\MIGRATION_LOCK_exclusive-attforgot.txt
echo STARTED %DATE% %TIME% > logs\exclusive-attforgot-meta.txt
"C:\Program Files\Java\jdk-21\bin\java.exe" -Xmx2g -jar build\libs\Camel-Jpa-TN-0.0.1-SNAPSHOT.jar --spring.profiles.active=dev > "logs\migration-exclusive-20260908-160435.log" 2>&1
